...
if(isset($c_f) && isset($city) && isset($address) && isset($tel_number) && isset($n_siti) && isset($total_cost)) {
  ...
  $return_value = mysqli_query($db_conn, "INSERT INTO CLIENTE (CODICE_FISCALE, CITTA, INDIRIZZO, TELEFONO, N_SITI, SPESA_TOTALE) VALUES('$c_f', '$city', 
 '$address', '$tel_number', '$n_siti', '$total_cost')") or die(mysqli_error($db_conn));
