...
<head>
    ...
    <title>Dashboard Sviluppatore</title>
    ...
    <link rel="stylesheet" type="text/css" href="css/developer_page.css">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                <li class="active">
                    <a href="developer_page.php"><i class="fa fa-fw fa-dashboard"></i> Dashboard Sviluppatore</a>
                </li>
                <li>
...
<script src="js/developer_page.js"></script>
